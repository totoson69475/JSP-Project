...
<body>
    ...
    <div id="wrap">
        ...
        <div style="
			    ...
			    "
        >
        <form method="get" action="./Professor/Professor_Lecture.jsp" style="width:400px">
            <div>
            ...
            <!-- 오른쪽: 강의생성 버튼 -->
            <div class="search-group" style="width:400px;">
            	<button class="btn" style="margin-left: 325px; margin-top:35px;" onclick="loadContent('./Professor/Professor_Lecture_Ins.jsp')">강의생성</button>
            </div>
            </div>
        </div>
		<%
	        ...
	        <table id="Professor_table">
	            ...
	            <tr>
	                ...
	                <form action="" method="get">
		                ...
		                <button type="button" onclick="loadContent('./Professor/Professor_Lecture_Upd.jsp?subjectId=<%=lecture.getSubjectId()%>&roomId=<%= lecture.getRoomId() %>&profId=<%= lecture.getProfId() %>')">수정</button>
		                <%-- <button type="submit" onclick="loadContent(`./Professor/Professor_Lecture_Upd.jsp`)">수정</button> --%>
	                </form>
	                </td>
		        </tr>
		        <%
        ...
        <div style="text-align: center; margin-top: 20px;">
            ...
            if (prevPage > 0) {
            %>
                <a href="./Professor/Professor_Lecture.jsp?page=<%= prevPage %>" class="page-nav">&laquo;</a>
            <%
            } else {
            %>
            ...
            %>
                <a href="./Professor/Professor_Lecture.jsp?page=<%= i %>" class="paging"><%= i %></a>
            <%
                }
            }
            ...
            %>
                <a href="./Professor/Professor_Lecture.jsp?page=<%= nextPage %>" class="page-nav">&raquo;</a>
            <%
            } else {
            %>
