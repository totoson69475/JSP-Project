...
<body>
    ...
    <div id="wrap">
        <div class="search-container">
            <form method="get" action="./Professor/Professor_Attendance.jsp">
            <div>
		...
		%>
	        ...
	        <table id="Professor_table">
	            ...
	            <tr>
	                ...
	                <td>
	          		<form action="./Professor/Professor_Attendance_Select.jsp" method="get">
		                <input type="hidden" name="subjectId" value="<%= lecture.getSubjectId() %>">
		                <%-- <input type="hidden" name="StudentId" value="<%= lecture.getStudentId() %>"> --%>
		                <input type="hidden" name="profId" value="<%= lecture.getProfId() %>">
		                <button type="submit">출석관리</button>
	                </form>
	                </td>
		        </tr>
		        <%
	        ...
	        <div style="text-align: center; margin-top: 20px;">
	            ...
	            if (prevPage > 0) {
	            %>
	                <a href="./Professor/Professor_Attendance.jsp?page=<%= prevPage %>" class="page-nav">&laquo;</a>
	            <%
	            } else {
	            %>
	            ...
	            %>
	                <a href="./Professor/Professor_Attendance.jsp?page=<%= i %>" class="paging"><%= i %></a>
	            <%
	                }
	            }
	            ...
	            %>
	                <a href="./Professor/Professor_Attendance.jsp?page=<%= nextPage %>" class="page-nav">&raquo;</a>
	            <%
	            } else {
	            %>
