...
<body>
	...
	<div id="wrap">
		...
		<input type="button" class="buttonSearch" style="width: 100px; float: right;" value = "공지사항 작성"
			onclick="loadContent('./Professor/Professor_Board_Create.jsp')"/>
		<br>
		<br>
			...
			<table class="studentTable" border="1px">
				...
				<tbody>
					...
					if (professorDTO != null) {
						System.out.println("professorDTO 세션에서 정상적으로 가져옴: " + professorDTO.getProf_name());
					} else {
						System.out.println("professorDTO 세션에 없음 (null)");
					}
					...
					<tr>
						...
						<td style="width: 535px;"><a
							onclick="loadContent('./Professor/Professor_Board_View.jsp?boardNum=<%=board.getBoard_num()%>')"><%=board.getBoard_title()%></a></td>
