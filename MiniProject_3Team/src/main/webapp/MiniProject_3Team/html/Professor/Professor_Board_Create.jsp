...
<body>
	<div id="wrap">
	<form action="./Professor/Professor_Board_Insert.jsp" method="post">
		<table class="studentTable" border="1px">
				<thead>
					<tr>
						<td style="width: 150px">제목</td>
						<td><input type="text" style="width: 985px; height: 29px;" name="titleInput" id="titleInput"/></td>
					</tr>
					<tr>
						<td style="width: 150px">내용</td>
						<td><textarea style="width: 985px; height: 600px;" name="contentInput" id="contentInput"></textarea></td>
					</tr>
				</thead>
				<tbody>
				</tbody>
