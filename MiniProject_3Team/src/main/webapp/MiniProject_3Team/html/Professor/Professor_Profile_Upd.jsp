...
<body>
	<form action="./Professor/Professor_Profile_UpdLoad.jsp" method="post">
	    <div id="wrap">
	        ...
	        <table id="Professor_table">
	            <tr>
	                ...
	                <td>
	                	<input type="text" name="prof_id" value="<%=professorDTO.getProf_id() %>" disabled>
	                 	<input type="hidden" name="prof_id" value="<%= professorDTO.getProf_id() %>">
    				 	<input type="hidden" name="dept_id" value="<%= professorDTO.getDept_id() %>">
	                </td>
	            </tr>
	            <tr>
	                <td class="small-cell">학과</td>
	                <td><input type="text" name="dept_name" value="<%= deptName %>" disabled></td>
	            </tr>
	            <tr>
	                <td class="small-cell">이름</td>
	                <td><input type="text" name="prof_name" value="<%= professorDTO.getProf_name() %>"></td>
	            </tr>
	            <tr>
	                <td class="small-cell">기타</td>
	                <td><input type="text" name="etc" value="<%= professorDTO.getEtc() %>"></td>
	            </tr>
	            <tr>
	                <td class="center-text">생년월일</td>
	                <td colspan="2"><input type="text" name="birthdate" value="<%= new java.text.SimpleDateFormat("yyyy-MM-dd").format(professorDTO.getBirthdate()) %>"></td>
	            </tr>
	            <tr>
	                <td class="center-text">전화번호</td>
	                <td colspan="2"><input type="text" name="phone" value="<%= professorDTO.getPhone() %>"></td>
	            </tr>
	            <tr>
	                <td class="center-text">주소</td>
	                <td colspan="2"><input type="text" name="address" value="<%= professorDTO.getAddress() %>"></td>
	            </tr>
	            <tr>
	                <td class="center-text">이메일</td>
	                <td colspan="2"><input type="text" name="email" value="<%= professorDTO.getEmail() %>"></td>
	            </tr>
	        </table>
	    </div>
    </form>
